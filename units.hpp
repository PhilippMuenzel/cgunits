/*
    ...
    Modified for C++17 constexpr by Philipp Ringler (ne Muenzel) 2018

    Github: https://github.com/PhilippMuenzel/cgunits
    Home page: http://calumgrant.net/units (defunct)
    File location: http://calumgrant.net/units/units.hpp (defunct)
...
namespace units
{
    ...
    typedef pow<detail::none, 0> unit;
...
namespace units
{
    namespace detail
    {
        ...
        template<bool> struct unit_static_assert;
        template<> struct unit_static_assert<true> { };
        ...
        {
            static constexpr bool value = check_terms_equal<Unit, T1, T2>::value;
        };
...
namespace units
{
    ...
    {
        template<typename Stream>
        static void fn(Stream &os) { detail::output_unit2<Unit>::fn(os); }
    };
...
namespace units
{
    ...
    // UNIT_DISPLAY_NAME( units::Hz, "Hz" );    // Too problematic, conflicts with rpm
    ...
    namespace units
    {
        ...
        typedef translate<Fahrenheit, -45967, 100> Rankine;
    ...
    UNIT_DISPLAY_NAME( units::Rankine,      "'R")
    ...
    UNIT_DISPLAY_NAME( units::gallon,       "US gallons" )
    UNIT_DISPLAY_NAME( units::mph,          "mph" )
    UNIT_DISPLAY_NAME( units::meters_per_second,"m/s" )
    UNIT_DISPLAY_NAME( units::kph,          "km/h" )
    UNIT_DISPLAY_NAME( units::knot,         "knots" )
    UNIT_DISPLAY_NAME( units::fpm,          "ft/min" )
    ...
    UNIT_DISPLAY_NAME( units::hPa,          "hPa" )
    UNIT_DISPLAY_NAME( units::inHg,         "inHg" )
    UNIT_DISPLAY_NAME( units::Torr,         "Torr" )
    UNIT_DISPLAY_NAME( units::mmHg,         "mmHg" )
    ...
    namespace values
    {
        ...
        typedef value<double, units::Rankine> Rankine;
        ...
        typedef value<double, units::gallon> gallon;
        ...
        typedef value<double, units::hPa> hPa;
        typedef value<double, units::inHg> inHg;
        typedef value<double, units::mmHg> mmHg;
        typedef value<double, units::Torr> Torr;
